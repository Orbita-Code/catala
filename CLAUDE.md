...
0. **NO TEXT / NO NAMES ON ILLUSTRATIONS (KRITIČNO — višejezičnost):** Nijedna ilustracija NE SME imati tekst/naziv na sebi — ni natpis prodavnice (FLECA, MERCAT, CINEMA, RESTAURANT), ni etiketu predmeta (COLA, SOAP). Iste slike se DELE za engleski/španski/druge jezike; tekst na katalonskom bi zahtevao novu sliku po jeziku. Prodavnice prikaži prepoznatljivo kroz robu/izlog/tendu/simbol (pekara→hlebovi u izlogu, piljarnica→gajbe voća, bioskop→filmske rolne/sedišta), NIKAD kroz natpis. Dvosmislen predmet bez teksta (lepak-stik vs balzam) reši oblikom/detaljem (izvučen beli lepak, nanet trag lepka). Prompt UVEK sadrži „no text, no letters, blank sign". Vidi memory `feedback_illustrations_no_text_multilang`.
