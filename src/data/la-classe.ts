...
export const laClasseTasks: Task[] = [
  ...
  // Exercise 3: Completa la paraula (all classroom items)
  {
    ...
    words: [
      { word: "llapis", hint: "_la_is" },
      { word: "goma", hint: "_o_a" },
      { word: "llibre", hint: "_li_re" },
      { word: "bolígraf", hint: "_olí_raf" },
      { word: "llibreta", hint: "_li_reta" },
      { word: "retolador", hint: "_eto_ador" },
      { word: "carpeta", hint: "_ar_eta" },
      { word: "estoig", hint: "e_toi_" },
      { word: "maquineta", hint: "_aqui_eta" },
      { word: "regle", hint: "_e_le" },
      { word: "motxilla", hint: "_otxi_la" },
      { word: "tisores", hint: "_i_ores" },
      { word: "pissarra", hint: "_i_arra" },
      { word: "guix", hint: "_ui_" },
      { word: "borrador", hint: "_o_rador" },
      { word: "paperera", hint: "_a_erera" },
      { word: "ordinador", hint: "o_di_ador" },
      { word: "taula", hint: "_au_a" },
      { word: "cadira", hint: "_adi_a" },
      { word: "porta", hint: "_o_ta" },
      { word: "finestra", hint: "_ine_tra" },
    ],
  },
