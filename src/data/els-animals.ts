...
export const elsAnimalsTasks: Task[] = [
  ...
  // === Fill-letters for key vocabulary ===
  {
    ...
    words: [
      { word: "gallina", hint: "_a_lina" },
      { word: "oreneta", hint: "o_e_eta" },
      { word: "papallona", hint: "_a_allona" },
      { word: "cocodril", hint: "_o_odril" },
      { word: "elefant", hint: "e_efa_t" },
      { word: "hipopòtam", hint: "_ipopòta_" },
      { word: "tortuga", hint: "_o_tuga" },
      { word: "sardina", hint: "_a_dina" },
    ],
  },
