...
export const laCasaTasks: Task[] = [
  ...
  // ── Task 5: Completa (fill letters) ──
  {
    ...
    prompt: "Completa:",
    words: [
      { word: "teulada", hint: "_eu_ada" },
      { word: "xemeneia", hint: "_e_eneia" },
      { word: "antena", hint: "a_te_a" },
      { word: "balcó", hint: "_a_có" },
      { word: "persiana", hint: "_e_siana" },
      { word: "cortina", hint: "_o_tina" },
      { word: "escala", hint: "e_ca_a" },
      { word: "jardí", hint: "_a_dí" },
      { word: "garatge", hint: "_a_atge" },
    ],
  },
  ...
  // ── Task 8: Completa (fill letters - habitacions) ──
  {
    ...
    prompt: "Completa:",
    words: [
      { word: "lavabo", hint: "_a_abo" },
      { word: "dormitori", hint: "do__itori" },
      { word: "cuina", hint: "_ui_a" },
      { word: "sala d'estar", hint: "_ala d'e_tar" },
      { word: "menjador", hint: "_e_jador" },
      { word: "terrassa", hint: "te__a_sa" },
    ],
  },
