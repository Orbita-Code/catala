...
export const elMenjarTasks: Task[] = [
  // === Workbook Ex. 1: Llegeix i copia (tableware 9) ===
  {
    ...
    words: [
      { catalan: "tassa", image: "tassa" },
      { catalan: "ampolla", image: "ampolla" },
      { catalan: "got", image: "got" },
      { catalan: "copa", image: "copa" },
      { catalan: "ganivet", image: "ganivet" },
      { catalan: "cullera", image: "cullera" },
      { catalan: "forquilla", image: "forquilla" },
      { catalan: "plat", image: "plat" },
  ...
  // === Workbook Ex. 4: Observa aliments esmorzar (9) ===
  {
    ...
    words: [
      { catalan: "suc", image: "suc" },
      { catalan: "cafè", image: "cafe" },
      { catalan: "pa de pessic", image: "pa-de-pessic" },
      { catalan: "te", image: "te" },
      { catalan: "cereals", image: "cereals" },
      { catalan: "llet", image: "llet" },
      { catalan: "galetes", image: "galetes" },
      { catalan: "entrepà", image: "entrepa" },
      { catalan: "fruita", image: "fruita" },
    ],
  },
  ...
  // === Fill-letters for key vocabulary ===
  {
    ...
    words: [
      { word: "forquilla", hint: "f_rqu_lla", image: "forquilla" },
      { word: "ganivet", hint: "g_n_v_t", image: "ganivet" },
      { word: "cullera", hint: "c_ll_ra", image: "cullera" },
      { word: "tovalló", hint: "t_v_lló", image: "tovallo" },
      { word: "ampolla", hint: "_mp_lla", image: "ampolla" },
      { word: "cereals", hint: "c_re_ls", image: "cereals" },
      { word: "hamburguesa", hint: "h_mb_rgu_sa", image: "hamburguesa" },
      { word: "macarrons", hint: "m_c_rr_ns", image: "macarrons" },
    ],
  },
  ...
  // === AUTOAVALUACIÓ ===
  {
    ...
    items: [
      ...
      { catalan: "forquilla", translation: "viljuška", image: "forquilla" },
      { catalan: "plat", translation: "tanjir", image: "plat" },
      { catalan: "tassa", translation: "šolja", image: "tassa" },
      { catalan: "got", translation: "čaša", image: "got" },
      { catalan: "cereals", translation: "žitarice", image: "cereals" },
      { catalan: "sopa", translation: "supa", image: "sopa" },
      { catalan: "hamburguesa", translation: "hamburger", image: "hamburguesa" },
      { catalan: "gelat", translation: "sladoled", image: "gelat" },
    ],
  },
