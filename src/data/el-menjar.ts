...
export const elMenjarTasks: Task[] = [
  ...
  // === Fill-letters for key vocabulary ===
  {
    ...
    words: [
      { word: "forquilla", hint: "_or_uilla" },
      { word: "ganivet", hint: "_ani_et" },
      { word: "cullera", hint: "_u_lera" },
      { word: "tovalló", hint: "_ova_ló" },
      { word: "ampolla", hint: "a_po_la" },
      { word: "cereals", hint: "_erea_s" },
      { word: "hamburguesa", hint: "_a_burguesa" },
      { word: "macarrons", hint: "_aca_rons" },
    ],
  },
