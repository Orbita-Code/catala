...
export const laCiutatTasks: Task[] = [
  ...
  },
  {
    ...
    words: [
      { word: "carrer", hint: "_a__er" },
      { word: "plaça", hint: "_laça" },
      { word: "hospital", hint: "_os_ital" },
      { word: "escola", hint: "e__ola" },
      { word: "biblioteca", hint: "_i_lioteca" },
      { word: "estació", hint: "e_ta_ió" },
      { word: "museu", hint: "_u_eu" },
      { word: "cinema", hint: "_i_ema" },
      { word: "semàfor", hint: "_emà_or" },
      { word: "mercat", hint: "_e__at" },
    ],
  },
  {
    id: "la-ciutat-3",
