...
export const lesBotiguesTasks: Task[] = [
  ...
  // === Workbook Ex. 1: Llegeix i copia les botigues ===
  {
    ...
    words: [
      ...
      // `supermercat` — ODLUKA VLASNICE 17.08.2026, posle provere.
      // Sveska (vežba 1) ima šest prodavnica i supermarketa među njima nema.
  ...
  // ne izmišlja, samo se već naučena reč seče na dva dela, po slogu.
  {
    ...
    pairs: [
      { left: "FLE", right: "CA" },
      { left: "FRUI", right: "TERIA" },
      { left: "CAR", right: "NISSERIA" },
      { left: "FAR", right: "MÀCIA" },
      { left: "PEI", right: "XETERIA" },
      { left: "VERDU", right: "LERIA" },
    ],
  },
