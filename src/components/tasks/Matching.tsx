      ...
      <div className="flex gap-4 justify-center">
        <div className="flex flex-col gap-2 flex-1 max-w-[200px]">
          {task.pairs.map((pair, i) => {
            ...
            return (
              ...
              >
                {getWordIllustration(pair.left) ? <img src={getWordIllustration(pair.left)!} alt="" className="w-10 h-10 object-contain inline mr-1" /> : getWordEmoji(pair.left) ? <span className="mr-1">{getWordEmoji(pair.left)}</span> : null}
        ...
        <div className="flex flex-col gap-2 flex-1 max-w-[200px]">
          {shuffledRight.map((actualIdx, displayIdx) => (
            ...
            >
              {getWordIllustration(task.pairs[actualIdx].right) ? <img src={getWordIllustration(task.pairs[actualIdx].right)!} alt="" className="w-10 h-10 object-contain inline mr-1" /> : getWordEmoji(task.pairs[actualIdx].right) ? <span className="mr-1">{getWordEmoji(task.pairs[actualIdx].right)}</span> : null}
